<template>
  <div>
    ...
    <el-table :data="tableData" align="center" resizable="true" fit="true" border="true" :header-cell-style="headerCellStyle"
      ...
      >
        <template slot-scope="scope">
          <el-input v-model="scope.row[item.variablename]" size="small" :style="inputStyle(item.input)"  v-if="item.input"></el-input>
          <el-select
...
export default {
  ...
  methods: {
    inputStyle(inputArr){
      //console.log("inputArr","width:"+inputArr[0]+"px;")
      return "width:"+inputArr[0]+"px;padding:2px"
    },
    //*************css******************/
    //表头css
    headerCellStyle() {
